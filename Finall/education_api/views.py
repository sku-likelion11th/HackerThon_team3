...
def api_education_search(request):
    if request.method == "GET":
        ...
        return render(request, 'education_api/Education.html', {'datas' : datas, 'paginator': paginator, 'curPage': curPage, 'range': custom_range})
    else:
        return render(request, 'education_api/Education.html')
